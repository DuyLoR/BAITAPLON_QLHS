<div class="container-fluid">
    ...
    <div class="col-lg-12">
        <div class="card card-outline card-primary border-2 border-info mt-4">
            <div class="card-body ">
                <form action="../process/process-add-student.php" id="manage-student">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="studentID" value=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="studentName" value=""
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="studentGender" id="" class="custom-select custom-select-sm" required>
                                    <option>Nam</option>
                                    <option>Nữ</option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="student_code" value=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="parnetName" value=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="parentPhone" value=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="parentEmail" value=""
                                        required>
                                </div>
                            </div>
                        </div>
