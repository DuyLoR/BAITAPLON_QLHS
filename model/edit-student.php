                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control form-control-sm" id="parentPhone" value=""
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control form-control-sm" id="parentEmail" value=""
                                        required>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#btnSubmit').click(function() {
        ...
        //? bắt nhập đủ
        if ($studentId == "" || $studentName == "" || $parentName == "" || $address == "" || $year ==
            "" || $parentPhone == "" || $parentEmail == "") {
            alert("Vui lòng nhập đủ thông tin");
            return;
        } else if (isNaN($parentPhone)) {
            alert("Số điện thoại không gồm kí tự");
            return;
