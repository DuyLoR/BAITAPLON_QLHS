                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <button
                                    name="<?php echo $row['magv'].','.$row['tengv'].','.$row['gioitinh'].','.$row['chucvu'].','.$row['sodt'].','.$row['email'].','.$row['diachi'];  ?>"
                                    class="btn btn-primary btn-flat manage_class editTeacher">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button name="<?php echo $row['magv'];  ?>"
                                    class="btn btn-danger btn-flat deleteTeacher">
