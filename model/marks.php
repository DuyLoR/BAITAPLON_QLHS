    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <div class="card-tools">
                <a class="btn btn-block btn-sm btn-default btn-flat border-primary newMark" href="javascript:void(0)"><i
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <button
                                    name="<?php echo $row['mahs'].','.$row['mamh'].','.$row['diemm'].','.$row['diemgk'].','.$row['diemck'];  ?>"
                                    class="btn btn-primary btn-flat manage_class editMark">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button id="<?php echo $row['mamh'];  ?>" name="<?php echo $row['mahs'];  ?>"
                                    class="btn btn-danger btn-flat deleteMark">
