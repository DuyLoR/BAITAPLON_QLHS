<div class="container-fluid">
    <h2 class="border-bottom border-info p-1">Thay đổi thông tin giáo viên</h2>
    <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="form-group text-dark">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="teacherID" value="" required disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
...
<script>
    $(document).ready(function() {
        ...
        $("#teacherGender").val($teacherGender);
