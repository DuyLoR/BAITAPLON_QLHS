<div class="container-fluid">
    ...
    <div class="col-lg-12">
        <div class="card card-outline card-primary border-2 border-info mt-4">
            <div class="card-body ">
                <form action="../process/process-add-teacher.php" id="manage-student">
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="teacherID" value=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="teacherName" value=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="teacherPosition"
                                        value="" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="control-label p-1 mt-1">Giới tính</label>
                                <select name="teacherGender" id="" class="custom-select custom-select-sm" required>
                                    <option>Nam</option>
                                    <option>Nữ</option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control form-control-sm" name="teacherPhone" value=""
                                        required>
                                </div>
                            </div>
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="teacherEmail" value=""
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group text-dark">
                                <div class="form-group">
                                    ...
                                    <textarea name="teacherAddress" id="address" cols="30" rows="5"
